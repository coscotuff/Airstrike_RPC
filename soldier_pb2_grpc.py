...
class AlertStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendResult = channel.unary_unary(
                '/soldier.Alert/SendResult',
                request_serializer=soldier__pb2.WarResult.SerializeToString,
                response_deserializer=soldier__pb2.void.FromString,
                )
...
def add_AlertServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SendResult': grpc.unary_unary_rpc_method_handler(
                    servicer.SendResult,
                    request_deserializer=soldier__pb2.WarResult.FromString,
                    response_serializer=soldier__pb2.void.SerializeToString,
            ),
    }
...
class Alert(object):
    ...
    def SendResult(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/soldier.Alert/SendResult',
            soldier__pb2.WarResult.SerializeToString,
            soldier__pb2.void.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
